...
# combine wqx and usgs pH data  -------------------------------------------
ph_data <- ph_wqx |>
  mutate(variable_name = "pH",
         statistic = tolower(statistic),
         unit = "std unit", # note that wqx was previouly none, "std unit" comes from USGS conventions
...
usethis::use_data(ph_gage, overwrite = TRUE)
